...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/RUIZTEAM/Files_RUIZ/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevRUIZW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevRUIZW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRUIZW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRUIZW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRUIZW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRUIZW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "UUUOU1")
...
RUIZ_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
RUIZ_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
RUIZ_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
RUIZ_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function SourceRUIZ(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."RUIZ1:List:Filter"..sl)
...
if not DevRUIZW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevRUIZW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,RUIZ_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✦' and DevRUIZW(msg) then  
...
if text == 'تعطيل التواصل ✦' and DevRUIZW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✦' and DevRUIZW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✦' and DevRUIZW(msg) then  
...
if text == 'ضع كليشه ستارت ✦' and DevRUIZW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✦︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✦' and DevRUIZW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✦︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✦' and DevRUIZW(msg) then 
...
if text == 'تحديث السورس ✦' and DevRUIZW(msg) then 
os.execute('rm -rf RUIZ.lua')
os.execute('wget https://raw.githubusercontent.com/RUIZTEAM/RUIZ/main/RUIZ.lua')
send(msg.chat_id_, msg.id_,' *✦︙تم تحديث السورس* \n*✦︙لديك اخر اصدار لسورس رويز*\n*✦︙الاصدار » { 2.8v}*')
dofile('RUIZ.lua')  
end
if text == 'الاصدار ✦' and DevRUIZW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✦︙اصدار سورس رويز* \n*✦︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✦' and DevRUIZW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✦︙[تحديثات البوت](t.me/RUIZTEAM) \n✦︙[قناه السورس](t.me/UUUOU1)')
end
if text == "ضع اسم للبوت ✦" and DevRUIZW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✦︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✦' and DevRUIZW(msg) then 
...
if text == 'المشتركين ✦' and DevRUIZW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✦︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✦' and DevRUIZW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✦︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✦") and DevRUIZW(msg) then
...
if text == ("قائمه العام ✦") and DevRUIZW(msg) then
...
if text == ("قائمه الكتم العام ✦") and DevRUIZW(msg) then
...
if text=="اذاعه خاص ✦" and msg.reply_to_message_id_ == 0 and DevRUIZW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✦︙ارسل الان اذاعتك؟* \n*✦︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✦" and msg.reply_to_message_id_ == 0 and DevRUIZW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✦︙ارسل الان اذاعتك؟* \n*✦︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✦" and msg.reply_to_message_id_ == 0 and DevRUIZW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✦︙ارسل الان اذاعتك؟* \n*✦︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✦" and msg.reply_to_message_id_ == 0  and DevRUIZW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✦︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✦" and msg.reply_to_message_id_ == 0  and DevRUIZW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✦︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✦' and DevRUIZW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✦" and DevRUIZW(msg) then
...
if text == "تنظيف الكروبات ✦" and DevRUIZW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✦︙عدد الكروبات الان » { '..#group..' }'..RUIZk..''..RUIZ..'*\n*✦︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevRUIZW(msg) then
...
usertext = '*\n ✦︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'UUUOU1')..')'
status  = '\n *✦︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevRUIZW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✦︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'UUUOU1')..')'
status  = '\n*✦︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevRUIZW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevRUIZW(msg) then
...
local RUIZ1_Msg = database:get(bot_id.."RUIZ1:Add:Filter:Rp2"..text..msg.chat_id_)   
if RUIZ1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✦︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UUUOU1')..') \n ✦︙'..RUIZ1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if RUIZ_Msg and not Special(msg) then  
local RUIZ_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if RUIZ_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✦︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✦︙["..RUIZ_Msg.."] \n")
else
send(msg.chat_id_,0," *✦︙العضو :* {["..data.first_name_.."](T.ME/UUUOU1)}\n✦︙["..RUIZ_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✦︙عذرا ↫* {["..data.first_name_.."](T.ME/UUUOU1)}\n*✦︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevRUIZW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevRUIZW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevRUIZW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✦︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevRUIZW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✦︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✦" and DevRUIZW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✦︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✦$") and DevRUIZW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✦︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✦" and DevRUIZW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✦" and DevRUIZW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✦︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✦" and DevRUIZW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."RUIZ:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."RUIZ:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_RUIZ = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_RUIZ then 
names_RUIZ = database:smembers(bot_id.."RUIZ:blocname"..msg.chat_id_) or ""
if names_RUIZ and names_RUIZ[1] then 
for i=1,#names_RUIZ do 
if name_RUIZ:match("(.*)("..names_RUIZ[i]..")(.*)") then 
...
database:set(bot_id.."RUIZ:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."RUIZ:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."RUIZ:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."RUIZ:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."RUIZ:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_RUIZa_new(RUIZ1,RUIZ2)
if RUIZ2 and RUIZ2.first_name_ then 
if RUIZ2.first_name_:match("(.*)"..database:get(bot_id.."RUIZ:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."RUIZ:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local RUIZ_nnn = database:get(bot_id.."RUIZ:nump"..msg.chat_id_) or 5
local RUIZ_nnn2 = database:get(bot_id.."RUIZ:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(RUIZ_nnn2) == tonumber(RUIZ_nnn) or tonumber(RUIZ_nnn2) > tonumber(RUIZ_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."RUIZ:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✦︙عزيزي >>["..RUIZ2.username_.."](https://t.me/"..(RUIZ2.username_ or "UUUOU1")..")\n✦︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."RUIZ:teh"..msg.chat_id_).."} بجانب اسمك\n✦︙عدد المحاولات المتبقيه {"..(tonumber(RUIZ_nnn) - tonumber(RUIZ_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_RUIZa_new)
end
end
...
local RUIZChengName = database:get(bot_id.."RUIZ:Cheng:Name"..data.id_)
if not data.first_name_ then 
if RUIZChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..RUIZChengName..']')
database:del(bot_id.."RUIZ:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if RUIZChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."RUIZ:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local RUIZChengUserName = database:get(bot_id.."RUIZ:Cheng:UserName"..data.id_)
if not data.username_ then 
if RUIZChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..RUIZChengUserName..']')
database:del(bot_id.."RUIZ:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if RUIZChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."RUIZ:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local RUIZChengPhoto = database:get(bot_id.."RUIZ:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if RUIZChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."RUIZ:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if RUIZChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."RUIZ:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʀᴏʟᴇх\n\n[✦  ʀᴏʟᴇх ᴄʜᴀɴɴᴇʟ](http://t.me/RUIZTEAM)\n\n[✦  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/UUUOU1)\n\n[✦  ʀᴏʟᴇх ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/XCGCC)\n\n[✦  ʙᴏᴛ ʀᴏʟᴇх](http://t.me/RUIZe_bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✦ sᴏᴜʀᴄʀ ʀᴏʟᴇх',url="t.me/UUUOU1/839"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UUUOU1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevRUIZW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*✦︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UUUOU1')..') \n*✦︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✦︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'UUUOU1')..') \n*✦︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevRUIZW(msg) then
dofile('RUIZ.lua')  
send(msg.chat_id_, msg.id_, ' *✦︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevRUIZW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevRUIZW(msg) then  
function start_function(extra, result, success)
if RUIZSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevRUIZW(msg) then  
...
if RUIZSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✦︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevRUIZW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if RUIZSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✦︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevRUIZW(msg) then  
function start_function(extra, result, success)
if RUIZSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✦︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevRUIZW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevRUIZW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if RUIZSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✦︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevRUIZW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevRUIZW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevRUIZW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevRUIZW(msg) then
...
if text == 'الملفات' and DevRUIZW(msg) then
t = ' *✦︙ملفات السورس رويز ↓*\n*•━━━━━━ 𝙍𝙪𝙞𝙯 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevRUIZW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/RUIZTEAM/Files_RUIZ/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✦︙اهلا بك في متجر ملفات رويز*\n*✦︙ملفات السورس ↓*\n*•━━━━━━ 𝙍𝙪𝙞𝙯 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝙍𝙪𝙞𝙯 ━━━━━━━•*\n *✦︙علامة تعني { ✓ } ملف مفعل*\n *✦︙علامة تعني { ✘ } ملف معطل*\n *✦︙قناة سورس رويز ↓*\n".." *✦︙*[اضغط هنا لدخول](t.me/UUUOU1) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevRUIZW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/RUIZTEAM/Files_RUIZ/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('RUIZ.lua')  
else
send(msg.chat_id_, msg.id_," *✦︙عذرا الملف لايدعم سورس رويز* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevRUIZW(msg) then
...
if text == "مسح الملفات" and DevRUIZW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✦︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevRUIZW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevRUIZW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "UUUOU1")
...
function Function_RUIZ(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_RUIZ, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_RUIZ, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✦︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'UUUOU1')..')'
status  = '\n*✦︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✦︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'UUUOU1')..')'
status  = '\n*✦︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✦︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✦︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'UUUOU1')..')'
...
database:set(bot_id.."RUIZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."RUIZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✦︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."RUIZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."RUIZ1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."RUIZ1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."RUIZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✦︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."RUIZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."RUIZ1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."RUIZ1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."RUIZ1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✦︙ارسل الكلمه الان*")  
database:set(bot_id.."RUIZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RUIZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."RUIZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RUIZ1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."RUIZ1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."RUIZ1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."RUIZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RUIZ1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."RUIZ1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevRUIZW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✦︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevRUIZW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✦︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'UUUOU1')..')'..'\n*✦︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevRUIZW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevRUIZW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'رويز').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'رويز')
local RUIZ_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..RUIZ_Msg[math.random(#RUIZ_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevRUIZW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,RUIZ)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝙍𝙪𝙞𝙯 ━━━━━━━•*\n"
x = 0
local list = RUIZ.members_
for k, v in pairs(list) do
x = x + 1
...
if RUIZSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevRUIZW(msg) then 
...
if text == ("ردود المطور") and DevRUIZW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✦︙قائمة ردود المطور \n*•━━━━━━ 𝙍𝙪𝙞𝙯 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevRUIZW(msg) then    
send(msg.chat_id_, msg.id_,' *✦︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevRUIZW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'رويز').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevRUIZW(msg) then   
...
if text == 'تعطيل المغادره' and DevRUIZW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✦︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'RUIZTEAM')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'UUUOU1')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
RUIZdx(msg.chat_id_, msg.id_, ' *✦︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✦︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✦︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✦︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevRUIZW(msg) then
...
{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙪𝙞𝙯.', url="t.me/RUIZTEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ✦∫ٴ*•━━━━━━ 𝙍𝙪𝙞𝙯 ━━━━━━━•*ٴ✦∫○ٴ\n✦︙[𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙪𝙞𝙯.](t.me/UUUOU1) ')
end
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʀᴏʟᴇх',url='http://t.me/RUIZTEAM'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'رويز')
...
RUIZ = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(RUIZ)
...
------------------------------------------------------------------------
local RUIZAbot = database:get(bot_id.."RUIZ1:Add:Filter:Rp2"..text..result.chat_id_)   
if RUIZAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✦︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✦︙["..RUIZAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local RUIZ1_Msg = database:get(bot_id.."RUIZ1:Add:Filter:Rp2"..text..result.chat_id_)   
if RUIZ1_Msg then
send(msg.chat_id_, msg.id_," ✦︙"..RUIZ1_Msg)
